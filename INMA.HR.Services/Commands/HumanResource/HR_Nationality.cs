...
namespace INMA.HR.Services
{
    ...
    //This Command is for Nationality Local Storage
    [Command(Name = "HR_Nationality_Get")]
    public class HR_Nationality_GetCommand : CamelCommandBase
    {
        protected override object DoAction(object v)
        {
            ...
            CommandParameters _params = new CommandParameters();
            values = _params.Get(model);
            return repository.GetMultiple<dynamic>(StoreProcedure.HR_Nationality_Get.ToString(), values, XtremeFactory._factory, XtremeFactory.connectionString);
