...
function fnLoadOtherMainSection_TechnicalArea(selectedValue) {
    ...
    if (selectedValue == 'Yes') {
        ...
        function stepper_Fn_otherMainSection_Onselect(e) {
            ...
            if (stepper_data.label != 'Select') {
                ...
                loadProject_TechnicalSectiondownLists();
                $("#Project_TechnicalSection_SetupDetailTypeDDL").data("kendoDropDownList").dataSource.data([]);
    ...
    function fnLoadOtherMainSection_TechnicalArea_Callback(response) {
        $("#Project_TechnicalSection_SetupDetailTypeDDL").data("kendoDropDownList").dataSource.data([]);
        fnloadProject_TechnicalSectiondownListsCallBack(response);
    }
