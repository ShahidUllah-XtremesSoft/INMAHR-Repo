...
namespace INMA.Projects.Services.Project
{
    ...
    #endregion
    #region MEETING MULTIPLE GET BY ID

    [Command(Name = "Meeting_Multiple_Get_By_Id")]
    public class Meeting_Multiple_Get_By_IdCommand : CamelCommandBase
    {
        protected override object DoAction(object viewInput)
        {
            ...
            values = _params.Get(model);
            return repository.GetMultiple<dynamic>(ProjectStoreProcedure.Meeting_Multiple_Get_By_Id.ToString(), values, XtremeFactory._factory, XtremeFactory.projectconnectionString);
