...
var bindLeaveRequestGrid = function (inputDataJSON) {
    ...
    var gridColumns = [
        ...
        { field: "startDate", title: "Start Date", hidden: false, width: 20, template: "<span class='badge badge-info'>#:startDate#</span>" },
        { field: "endDate", title: "End Date", hidden: false, width: 20, template: "<span class='badge badge-danger'>#:endDate#</span>" },
        { field: "totalDays", title: "Days", hidden: false, width: 15, template: "<span class='badge badge-dark'>#:totalDays#</span>" },
...
$('#btnSave').click(function () {
    ...
    loopThroughGrid();
    buttonRemovePleaseWait('btnSave', 'Accept', 'check');
...
$('#btnCancel').click(function () {
    ...
    loopThroughGrid();
    buttonRemovePleaseWait('btnCancel', 'Decline', 'ban');
});
