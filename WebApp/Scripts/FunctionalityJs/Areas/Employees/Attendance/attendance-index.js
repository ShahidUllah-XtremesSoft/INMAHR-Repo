...
function loadAttendanceGrid() {
    ...
    ajaxRequest({ commandName: 'Employee_Attendance_GetByDepartment', values: { CheckInDate: checkInDate, DepartmentIds: $('#DepartmentIds').val(), LoggedInEmployeeId: loggedInEmployeeId, Language: _currentLanguage }, CallBack: loadAttendanceGridCallBack });
}
